<?php
//page adapted from: Otto, M., Thornton, J. (n.d.). Jumbotron Bootstrap Example. Bootstrap. Received February 18, 2023 from https://getbootstrap.com/docs/5.2/examples/jumbotron/
require 'auth.php';
